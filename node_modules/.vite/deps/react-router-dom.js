import {
  require_react_dom
<<<<<<< HEAD
} from "./chunk-7SLCXQCX.js";
import {
  require_react
} from "./chunk-BVJBJJA6.js";
=======
} from "./chunk-BKSKPETM.js";
import {
  require_react
} from "./chunk-WZKVZ3QC.js";
...
function createRouter(init) {
  ...
  async function handleAction(request, location2, submission, matches, historyAction, scopedContext, isFogOfWar, initialHydration, opts = {}) {
    interruptActiveLoads();
  ...
  async function handleLoaders(request, location2, matches, historyAction, scopedContext, isFogOfWar, overrideNavigation, submission, fetcherSubmission, replace2, initialHydration, flushSync3, pendingActionResult, callSiteDefaultShouldRevalidate) {
    let loadingNavigation = overrideNavigation || getLoadingNavigation(location2, matches, historyAction, submission);
  ...
  async function startRedirectNavigation(request, redirect2, isNavigation, {
    ...
    if (isBrowser3) {
      ...
      if (redirect2.response.headers.has("X-Remix-Reload-Document")) {
        ...
        const url = createBrowserURLImpl(routerWindow, location2, true);
...
function getLoadingNavigation(location2, matches, historyAction, submission) {
  if (submission) {
    let navigation = {
      state: "loading",
      location: location2,
...
function getSubmittingNavigation(location2, matches, historyAction, submission) {
  let navigation = {
    state: "submitting",
    location: location2,
    matches,
...
function useRouterState() {
  ...
  let active = React2.useMemo(
    () => ({
      type,
      location: location2,
      searchParams: new URLSearchParams(location2.search),
