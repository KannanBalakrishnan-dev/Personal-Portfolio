...
var PresenceChild = ({ children, initial, isPresent: isPresent2, onExitComplete, custom, presenceAffectsLayout, mode, anchorX, anchorY, root }) => {
  ...
  const isPresentRef = (0, import_react7.useRef)(isPresent2);
  const onExitCompleteRef = (0, import_react7.useRef)(onExitComplete);
  useIsomorphicLayoutEffect(() => {
    isPresentRef.current = isPresent2;
...
function useVisualElement(Component3, visualState, props, createVisualElement2, ProjectionNodeConstructor, isSVG) {
  ...
  const wantsHandoff = (0, import_react26.useRef)(Boolean(optimisedAppearId) && typeof window !== "undefined" && !window.MotionHandoffIsComplete?.(optimisedAppearId) && window.MotionHasOptimisedAnimation?.(optimisedAppearId));
  useIsomorphicLayoutEffect(() => {
...
function createMotionComponent(Component3, { forwardMotionProps = false, type } = {}, preloadedFeatures, createVisualElement2) {
  ...
  function MotionDOMComponent(props, externalRef) {
    ...
    if (!isStatic && typeof window !== "undefined") {
      ...
      context.visualElement = useVisualElement(Component3, visualState, configAndProps, createVisualElement2, layoutProjection.ProjectionNode, isSVG);
    }
...
function createMotionProxy(preloadedFeatures, createVisualElement2) {
  ...
  const factory = (Component3, options) => {
    return createMotionComponent(Component3, options, preloadedFeatures, createVisualElement2);
  };
  ...
  return new Proxy(deprecatedFactoryFunction, {
    ...
    get: (_target, key) => {
      ...
      if (!componentCache.has(key)) {
        componentCache.set(key, createMotionComponent(key, void 0, preloadedFeatures, createVisualElement2));
      }
...
function useAnimate() {
  ...
  const { skipAnimations } = (0, import_react38.useContext)(MotionConfigContext);
  const animate2 = (0, import_react38.useMemo)(() => createScopedAnimate({ scope, reduceMotion, skipAnimations }), [scope, reduceMotion, skipAnimations]);
  useUnmountEffect(() => {
