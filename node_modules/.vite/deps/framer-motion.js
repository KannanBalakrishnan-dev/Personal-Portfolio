...
var PresenceChild = ({ children, initial, isPresent, onExitComplete, custom, presenceAffectsLayout, mode, anchorX, anchorY, root }) => {
  ...
  const isPresentRef = (0, import_react2.useRef)(isPresent);
  const onExitCompleteRef = (0, import_react2.useRef)(onExitComplete);
  useIsomorphicLayoutEffect(() => {
...
var AnimatePresence = ({ children, custom, initial = true, onExitComplete, presenceAffectsLayout = true, mode = "sync", propagate = false, anchorX = "left", anchorY = "top", root }) => {
  ...
  const exitingComponents = (0, import_react4.useRef)(/* @__PURE__ */ new Set());
...
function MotionConfig({ children, isValidProp, ...config }) {
  ...
  const parentConfig = (0, import_react10.useContext)(MotionConfigContext);
...
function useAnimate() {
  ...
  const { skipAnimations } = (0, import_react19.useContext)(MotionConfigContext);
  const animate2 = (0, import_react19.useMemo)(() => createScopedAnimate({ scope, reduceMotion, skipAnimations }), [scope, reduceMotion, skipAnimations]);
  useUnmountEffect(() => {
...
function useCycle(...items) {
  const index = (0, import_react23.useRef)(0);
  const [item, setItem] = (0, import_react23.useState)(items[index.current]);
  const runCycle = (0, import_react23.useCallback)(
    (next) => {
...
function useInView(ref, { root, margin, amount, once = false, initial = false } = {}) {
  const [isInView, setInView] = (0, import_react24.useState)(initial);
...
function useInstantTransition() {
  ...
  const unlockOnFrameRef = (0, import_react25.useRef)(-1);
...
function usePageInView() {
  const [isInView, setIsInView] = (0, import_react26.useState)(true);
...
function useAnimatedState(initialState) {
  const [animationState, setAnimationState] = (0, import_react27.useState)(initialState);
...
function useInvertedScale(scale2) {
  ...
  const { visualElement } = (0, import_react28.useContext)(MotionContext);
...
function ReorderGroupComponent({ children, as = "ul", axis = "y", onReorder, values, ...props }, externalRef) {
  ...
  const groupRef = (0, import_react30.useRef)(null);
  ...
  return (0, import_jsx_runtime8.jsx)(Component2, { ...props, style: groupStyle, ref: setRef2, ignoreStrict: true, children: (0, import_jsx_runtime8.jsx)(ReorderContext.Provider, { value: context, children }) });
}
var ReorderGroup = (0, import_react30.forwardRef)(ReorderGroupComponent);
...
function ReorderItemComponent({ children, style = {}, value, as = "li", onDrag, onDragEnd, layout: layout2 = true, ...props }, externalRef) {
  const Component2 = useConstant(() => motion[as]);
  const context = (0, import_react31.useContext)(ReorderContext);
  const point2 = {
...
var ReorderItem = (0, import_react31.forwardRef)(ReorderItemComponent);
export {
  AnimatePresence,
  AnimateSharedLayout,
  AsyncMotionValueAnimation,
